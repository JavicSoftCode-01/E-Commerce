...
//         if (confirm("Esta seguro de eliminar?")) { //
//           //Llamar al service, el metodo de indexeddb eliminar, pasamos  id
//           await this.categoriaService.eliminarCategoria(categoriaId);  //
//           //Actualiza
//           await this.cargarCategorias();      // Vuelve a cargar categorias
//           // Para actualizar select de Productos.
//           await this.cargarOpcionesProductoForm(); //   productos
...
//
//           //Llamar al service, el metodo de indexeddb eliminar, pasamos  id
//           await this.marcaService.eliminarMarca(marcaId);  //
//
//           //Actualiza
//           await this.cargarMarcas();      // Vuelve a cargar marcas
//           // Para actualizar select de Productos.
...
//
//           //Llamar al service, el metodo de indexeddb eliminar, pasamos  id
//           await this.proveedorService.eliminarProveedor(proveedorId);  //
//           //Actualiza
//           await this.cargarProveedores();      // Vuelve a cargar proveedores
//           // Para actualizar select de Productos.
//           await this.cargarOpcionesProductoForm(); //   productos
...
//
//           //Llamar al service, el metodo de indexeddb eliminar, pasamos  id
//           await this.clienteService.eliminarCliente(clienteId);  //
//
//           //Actualiza
//           await this.cargarClientes();      // Vuelve a cargar clientes
//         }  //Cierra confirm()
...
//           //Actualiza
//           await this.cargarProductos();      // Vuelve a cargar productos
//           tiendaController.cargarProductos();
//         }  //Cierra confirm()
//       }); //cierra Listener
//
//     });  // cierra forEach, setupProductoListeners
...
//   async cargarOpcionesProductoForm() {
//     try {
//       const categorias = appService.getCategorias();
//       const marcas = appService.getMarcas();
//       const proveedores = appService.getProveedores();
//       // Limpiar antes (por precaucion)
//
//       this.productoCategoriaSelect.innerHTML = '<option value="">Seleccione Categoría</option>'; // reset
//       this.productoMarcaSelect.innerHTML = '<option value="">Seleccione Marca</option>';       //
//       this.productoProveedorSelect.innerHTML = '<option value="">Seleccione Proveedor</option>';     //
//       //Llena  los selects:
//       categorias.forEach(categoria => {   // .forEach( item =>  ...  Añade opcion (con su ID en valor)
//
//         this.productoCategoriaSelect.innerHTML += `<option value="${categoria.id}">${categoria.nombre}</option>`;// append, a todo.
//       });  // Cierra forEach
//       marcas.forEach(marca => {
//         this.productoMarcaSelect.innerHTML += `<option value="${marca.id}">${marca.nombre}</option>`; // ID -> Value, TEXTO/Nombre -> Texto
//       });
//
//       proveedores.forEach(proveedor => {  // item actual: "proveedor".  (singular).
//         this.productoProveedorSelect.innerHTML += `<option value="${proveedor.id}">${proveedor.nombre}</option>`; //
//       });
//     } catch (error) {     // Errores
//                           //Feedback, si falla.
