...
//
//       // Convertir los detalles en instancias de DetalleFactura y enriquecer con datos del producto
//       const detalles = await Promise.all(facturaData.detalles.map(async detalle => {
...
//           detalle.cantidad
//         );
//         // Agregar propiedades adicionales del producto
//         detalleFactura.imagen = producto?.imagen || '';
//         return detalleFactura;
//       }));
//
//       // Crear una nueva instancia de Factura con los detalles enriquecidos
